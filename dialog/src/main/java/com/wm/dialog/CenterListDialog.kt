...
class CenterListDialog(context: Context,var textColor:Int): CenterPopupView(context) {
     ...
     * @return
     */
    fun bindLayout(layoutId: Int): CenterListDialog? {
     ...
     * @return
     */
    fun bindItemLayout(itemLayoutId: Int): CenterListDialog {
        bindItemLayoutId = itemLayoutId
        return this
    }

    override fun getImplLayoutId(): Int {
        return if (bindLayoutId == 0) com.lxj.xpopup.R.layout._xpopup_center_impl_list else bindLayoutId
    }
    ...
    fun setOnSelectListener(selectListener: OnSelectListener?): CenterListDialog? {
     ...
     * @return
     */
    fun setCheckedPosition(position: Int): CenterListDialog {
        checkedPosition = position
        return this
    }

    override fun getMaxWidth(): Int {
        return if (popupInfo.maxWidth == 0) (super.getMaxWidth() * .8f).toInt() else popupInfo.maxWidth
    }
}